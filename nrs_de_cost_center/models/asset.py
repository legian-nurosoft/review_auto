    ...
    def _get_disposal_moves(self, invoice_line_ids, disposal_date):
        def get_line(asset, amount, account):
            return (0, 0, {
                ...
                'ns_cost_center_id': ns_cost_center_id.id if asset.asset_type == 'sale' and ns_cost_center_id else False,
                'ns_site_id': ns_site_id.id if asset.asset_type == 'sale' and ns_site_id else False,
                'ns_project_id': ns_project_id.id if asset.asset_type == 'sale' and ns_project_id else False,
                'ns_company_id': ns_company_id.id if asset.asset_type == 'sale' and ns_company_id else False,
